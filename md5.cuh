...
//void runMD5(unsigned char *hostPadding,unsigned char* oryginalHash, unsigned char* result );
 void runMD5(unsigned char *message ,unsigned char* oryginalHash,  unsigned char* result,  int len);
...
__device__ void generateMD5( unsigned char * message, uint1_md5* foundCollision, int len);
...
__device__ void generateMD5(unsigned char* ,unsigned char*);
